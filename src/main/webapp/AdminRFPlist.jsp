		...
		<div class="container2">
			...
			<div class="cont-2">
				...
				<div class="rfp">
					...
					<div class="home2">
						<p>RFP</p>
						<a href="./addCreateRFP" class="add-category-button">+ Add RFP</a>
					</div>
						...
						<tbody>
							<c:forEach var="rfp" items="${rfp}" varStatus="status">
								<tr>
									...
									<td><span
										style="background-color: ${rfp.aminStatus ? 'green' : 'red'}; border-radius: 50px; padding: 5px;color: white; font-style: italic;">
											${rfp.aminStatus ? 'Open' : 'Close'} </span></td>
									<td><a href="./changeRFPListSts?id=${rfp.rfpNo}"
										style="color: ${rfp.aminStatus ? 'red' : 'green'}; font-style: italic;">
											${rfp.aminStatus ? 'Close' : ''} </a></td>
